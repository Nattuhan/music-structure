...
Windows版とv1.2.2以降の署名済みMac版は、アプリ内で更新を確認し、ダウンロード後に再起動して適用できます。自動更新が有効なら起動時に確認します。以前のMac版からは、一度新しいDMGを公式Releaseから取得して入れ替えてください。曲、設定、処理履歴、追加機能はアプリ本体とは別の場所に保存されるため、通常の更新では消えません。
